...
![2018_論理ネットワーク構成図](images/network-2018.png)

- 外部公開用のサブネットを作成
　- サブネットと言いつつ、１台につき１サブネットでセキュリティを強化
- XG Firewallを直接WANに接続すると通信速度が遅くなるのでルーター経由で接続


## 2020_ネットワーク構成

![2020_論理ネットワーク構成図](images/network-2020.png)

- FortiGateを導入
- サーバ用サブネット以外はFortiGate配下に移動
